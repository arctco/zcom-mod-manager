...
import type { AppSettings, Links, ToolInfo } from "../types";
...
export function SettingsPage({ settings, retoc, onChange, onSave, onPickGame, onPickRetoc, onOpenLogs, onOpenData, links, onOpenLink }: Props) {
