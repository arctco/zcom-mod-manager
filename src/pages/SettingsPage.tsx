...
export function SettingsPage({ settings, retoc, onChange, onSave, onPickGame, onPickExecutable, onPickRetoc, onOpenLogs, onOpenData, links, onOpenLink, nexus, nexusAccount, onSaveNexusKey, onClearNexusKey, onToggleNxmHandler }: Props) {
