import { Activity, Download, FolderOpen, PackageCheck, Puzzle, ShieldCheck } from "lucide-react";
import { openPath } from "@tauri-apps/plugin-opener";
import type { Dashboard } from "../types";
import { StatusBadge } from "../components/StatusBadge";

export function HomePage({ data, onInstall, onDiagnose, onLocate, openMods }: { data: Dashboard; onInstall: () => void; onDiagnose: () => void; onLocate: () => void; openMods: () => Promise<void> }) {
